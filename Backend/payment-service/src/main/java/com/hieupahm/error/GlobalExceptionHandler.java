...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ExceptionResponse> UserExceptionHandler(ReviewException ex, WebRequest req) {
    ...
    public ResponseEntity<ExceptionResponse> ReviewExistExceptionHandler(ReviewException ex, WebRequest req) {
        ExceptionResponse response = new ExceptionResponse(
                ex.getMessage(),
                req.getDescription(false), LocalDateTime.now());
        return ResponseEntity.ok(response);
