    ...
    return (
        <div className="min-h-[90vh] flex justify-center items-center">
            {true ? <div className="bg-primary-color text-white p-8 w-[90%] lg:w-[25%] border rounded-md h-[40vh] flex flex-col gap-7 items-center justify-center">
                <h1 className="text-3xl font-semibold">Đã thanh toán!</h1>
                <h1 className="text-2xl font-semibold">Dịch vụ đã được thanh toán thành công!</h1>
                <div>
                    <Button onClick={() => navigate("/")} color="secondary" variant="contained">Quay lại trang chủ</Button>
                </div>
